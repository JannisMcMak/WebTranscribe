let essentia;
// let audioURL = 'https://cdn.freesound.org/previews/49/49658_514283-lq.mp3';
let audioURL = 'https://cdn.freesound.org/previews/840/840648_18297633-lq.mp3';
...
async function onClickFeatureExtractor() {
	...
	// let pitchMelodia = essentia.PitchMelodia(
	// 	audioVector, // input
	// 	// parameters (optional)
	// 	10, // binResolution,
	// 	3, // filterIterations
	...
	// 	128 // hopSize
	// );
	let result = essentia.BeatTrackerDegara(audioVector);

	let pitches = essentia.vectorToArray(result.ticks);
	console.log(pitches);
...
$(document).ready(function () {
	...
	EssentiaWASM().then(async function (WasmModule) {
		...
		$('#logDiv').html('<h5> essentia-' + essentia.version + ' wasm backend loaded ... </h5>');
